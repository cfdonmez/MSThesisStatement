...
\caption{Parabolik kolektör vasıtasıyla ısı ve elektrik eldesi}
\label{fig:parabolik}
\end{figure}
...
\caption{İkili (binary) çevrim jeotermal enerji santrali üretim topolojisi \protect\cite{dipippo2012geothermal}.}
\label{fig:binary}
\end{figure}
...
\caption{Hidroelektrik enerji santrali üretim diyagramı}
\label{fig:hidroelek}
\end{figure}