...
\include{OnKisim/2TezOnay}
\addcontentsline{toc}{chapter}{BİLİMSEL ETİK BİLDİRİMİ}
%-----------------------------------------
\include{OnKisim/3YeminMetni}
\addcontentsline{toc}{chapter}{ÖZGEÇMİŞ}

\include{OnKisim/4Ozgecmis}
\addcontentsline{toc}{chapter}{ÖZET}
\input{OnKisim/5Ozet}
\addcontentsline{toc}{chapter}{ABSTRACT}
\include{OnKisim/6Abstract}
\addcontentsline{toc}{chapter}{ÖNSÖZ}
\include{OnKisim/7Onsoz}
%----------------------
...
\include{MetinKisim/Bolum1}
\include{MetinKisim/Bolum2}
\include{MetinKisim/Bolum3}
\include{MetinKisim/Bolum4}
\include{MetinKisim/Bolum5}
